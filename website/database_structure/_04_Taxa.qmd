## [Taxa]{.text-background-blueDark .text-color-white .text-bold}
...
### [Taxa Structure Overview]{.text-background-blueDark .text-color-white .text-bold} (`[Taxa]{.text-background-blueDark .text-color-white .text-bold}`)

The **[VegVault]{.text-background-black .text-color-white .text-bold}** database records the original [taxonomic names]{.text-background-blueDark .text-color-white .text-bold} derived directly from the [primary data sources]{.text-background-brownDark .text-color-white .text-bold}, and currently, it holds over 100 thousand [taxonomic names]{.text-background-blueDark .text-color-white .text-bold}. 
