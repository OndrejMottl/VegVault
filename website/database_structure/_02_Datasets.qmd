## [Datasets]{.text-background-brownDark .text-color-white .text-bold}
...
#### [Dataset Types]{.text-background-brownDark .text-color-white .text-bold} (`[DatasetTypeID]{.text-background-brownDark .text-color-white .text-bold}`)
...
-	[`vegetation_plot`]{.text-background-greenLight .text-color-black .text-bold}: This type includes [contemporary vegetation plot data]{.text-background-greenLight .text-color-black .text-bold}, capturing contemporary vegetation characteristics and distributions.
-	[`fossil_pollen_archive`]{.text-background-purpleLight .text-color-black .text-bold}: This type encompasses [past vegetation plot data]{.text-background-purpleLight .text-color-black .text-bold} derived from [fossil pollen records]{.text-background-purpleLight .text-color-black .text-bold}, providing insights into past vegetation and climate dynamics.
-	[`traits`]{.text-background-blueDark .text-color-white .text-bold}: This type contains [functional trait data]{.text-background-blueDark .text-color-white .text-bold}, detailing specific characteristics of plant species that influence their ecological roles.
-	[`gridpoints`]{.text-background-greenDark .text-color-white .text-bold}: This type holds artificially created [`Datasets`]{.text-background-brownDark .text-color-white .text-bold} to manage [abiotic data]{.text-background-greenDark .text-color-white .text-bold}, here [climate]{.text-background-greenDark .text-color-white .text-bold} and [soil information]{.text-background-greenDark .text-color-white .text-bold} (a [dataset type]{.text-background-brownDark .text-color-white .text-bold} created to hold [abiotic data]{.text-background-greenDark .text-color-white .text-bold}, see details in the Methods section).
...
#### [Dataset Source-Types]{.text-background-brownDark .text-color-white .text-bold} (`[DatasetSourceTypeID]{.text-background-brownDark .text-color-white .text-bold}`)
...
- **[Neotoma-FOSSILPOL]{.text-background-purpleLight .text-color-black .text-bold}** - [The workflow that aims to process and standardise global palaeoecological pollen data](https://hope-uib-bio.github.io/FOSSILPOL-website/). Note that we specifically state [Neotoma-FOSSILPOL]{.text-background-purpleLight .text-color-black .text-bold} and not just Neotoma, as [FOSSILPOL]{.text-background-purpleLight .text-color-black .text-bold} not only provides the [data acquisition]{.text-background-brownLight .text-color-black .text-bold} but also alters it (e.g., creating new [age-depth models]{.text-background-purpleLight .text-color-black .text-bold}). It also addresses major challenges in [paleoecological data integration]{.text-background-purpleLight .text-color-black .text-bold}, such as [age uncertainty]{.text-background-purpleLight .text-color-black .text-bold}, by incorporating [probabilistic age-depth models]{.text-background-purpleLight .text-color-black .text-bold} and their associated [uncertainty matrices]{.text-background-purpleLight .text-color-black .text-bold}. This enables the propagation of [temporal uncertainty]{.text-background-purpleLight .text-color-black .text-bold} in subsequent analyses, a critical advancement for robust macroecological studies, previously flagged as a major issue with [paleo-data]{.text-background-purpleLight .text-color-black .text-bold}.
- **[gridpoints]{.text-background-greenDark .text-color-white .text-bold}** - artificially created [`Datasets`]{.text-background-brownDark .text-color-white .text-bold} to hold [abiotic data]{.text-background-greenDark .text-color-white .text-bold} 
