...
`Samples` represent the main unit of data in **VegVault**, serving as the fundamental building blocks for all analyses. There are currently over 13 million `Samples` in **VegVault** v1.0.0 (of which ~ 1.6 million are gridpoints of abiotic data, see [Database content](/website/database_content.qmd)). 
