...
knitr::include_graphics(
  here::here(
    "R/03_Technical_overview/DB_assembly_visualisation/assembly_viz_01.png"
  )
)
```
...
11. **[VegVault-Trait_data GitHub repo](https://github.com/OndrejMottl/VegVault-Trait_data/tree/v1.0.0)**
    * a Tag (v1.0.0) to process vegetation trait data
12. **[VegVault-abiotic_data GitHub repo](https://github.com/OndrejMottl/VegVault-abiotic_data/tree/v1.0.0)**
