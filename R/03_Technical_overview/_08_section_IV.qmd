...
In the second example, let's imagine we want to do Joined - Species Distribution Modeling for all plant taxa in the Czech Republic. We will extract modern plot-based data and climate.
...
fig_cz_modern <-
  ...
  ggplot2::labs(
    ...
    x = "Longtitude",
    y = "Latitude",
    col = "Mean Annual Temperature (°C)",
    fill = "Mean Annual Temperature (°C)",
...
In the last example, let's imagine we want to recostruct the Community Weighted Mean (CWM) of plant heigh for Latin America between 6-12 ka yr BP.
...
fig_la_height <-
  ...
  ggplot2::labs(
    y = "Average Plant heigh per taxa"
  ) +
