...
CREATE TABLE "TaxonClassification" (
  ...
  FOREIGN KEY ("taxon_name_agree") REFERENCES "Taxa" ("taxon_id"),
...
CREATE TABLE "References" (
  ...
  FOREIGN KEY ("reference_id") REFERENCES "Samples" ("sample_referecne"),
  FOREIGN KEY ("reference_id") REFERENCES "TaxonClassification" ("taxon_reference"),
  FOREIGN KEY ("reference_id") REFERENCES "Traits" ("trait_reference")
);
